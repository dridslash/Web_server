...
Server_Eyjafjörður::Server_Eyjafjörður():event_tracker(0){memset(changelist,0,sizeof(changelist));}
...
bool Server_Eyjafjörður::Add_Event_to_queue_ker(int fd , int filter){
    ...
    EV_SET(&changelist[event_tracker],fd,filter,EV_ADD | EV_CLEAR,0,0,NULL);
